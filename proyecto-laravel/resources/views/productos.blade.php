    ...
    <section id="productos" class="py-24 container mx-auto text-center flex-grow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 px-6">
            <div class="bg-gray-800 p-6 rounded-lg shadow-lg">
                ...
                <a href="/productos" class="mt-6 inline-block bg-red-600 text-white px-8 py-4 rounded-lg text-lg font-bold hover:bg-red-700 transition">Comprar</a>
            </div>
            <div class="bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <div class="bg-gray-800 p-6 rounded-lg shadow-lg">
                ...
                <a href="/productos" class="mt-6 inline-block bg-red-600 text-white px-8 py-4 rounded-lg text-lg font-bold hover:bg-red-700 transition">Comprar</a>            </div>
        </div>
    </section>
